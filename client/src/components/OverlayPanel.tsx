 ...
 * Usa createPortal para renderizar no body e garantir visibilidade
 */
...
export function OverlayPanel({ isOpen, onClose }: OverlayPanelProps) {
  ...
  const modalContent = (
    ...
    >
      ...
      {/* Modal */}
      <div 
        className="relative bg-gray-900 rounded-xl shadow-2xl border border-gray-700 flex flex-col w-full max-w-2xl max-h-[85vh] m-4"
